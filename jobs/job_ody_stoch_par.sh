...
#SBATCH -o /n/scratchlfs/conroy_lab/bdjohnson/jades_sed/logs/stochparfit_%A_%a.out # Standard out goes to this file
#SBATCH -e /n/scratchlfs/conroy_lab/bdjohnson/jades_sed/logs/stochparfit_%A_%a.err # Standard err goes to this file
...
outdir=./output
out=$outdir/stochastic_parametric_$objid

python ./fit_stochastic_with_parametric.py \
       --objid=$objid \
