...
from jadespro.parfiles.parametric_fsps import build_obs
from jadespro.parfiles.parametric_fsps import build_sps as build_par_sps
...
def build_all(**kwargs):
    ...
    sps_par = build_par_sps(object_redshift=red, **kwargs)
    obs = build_obs(sps=sps_par, **kwargs)
    del sps_par
